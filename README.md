...
> **🤖 AI Agents**: Before making changes, read the `replit.md` file for essential context. It contains all documentation you need.

## Quick Start for AI Assistants

1. Read `replit.md` - contains ALL context (code patterns, schemas, CLI commands, embed config)
2. Check `code/` for the actual implementation
3. Run `npm run preview` to test embed changes
